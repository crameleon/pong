...
/* VARIABLES */
	...
	// Gestion du clavier
	var aller_haut_J1 = false;
	var aller_bas_J1 = false;
...
/* FONCTIONS DE DESSIN */
	...
	var dessinerVictoire = function () {
		...
		if (scoreJ1 == SCORE_VICTOIRE) {
			...
			victoireContext.fillText("Joueur 1 a gagné la partie !!!",SCORE_VICTOIRE_X,SCORE_VICTOIRE_Y);
		} else {
			victoireContext.fillStyle = J2_COLOR;
			victoireContext.fillText("Joueur 2 a gagné la partie !!!",SCORE_VICTOIRE_X,SCORE_VICTOIRE_Y);
		}
	}
...
/* FONCTION DE MISE EN JEU */
	...
	var initialiserEngagementJ2 = function () {
		console.log("Engagement du Joueur 2");
		balle_en_jeu = true;
...
/* FONCTIONS DE GESTION DES ANIMATIONS */
	...
	var animerRaquetteJ1 = function () {
		if (aller_haut_J1 && RAQUETTE_J1_Y > 0)
			RAQUETTE_J1_Y = RAQUETTE_J1_Y - RAQUETTE_VITESSE;
		else if (aller_bas_J1 && RAQUETTE_J1_Y < TERRAIN_HEIGHT - RAQUETTE_HEIGHT)
			RAQUETTE_J1_Y = RAQUETTE_J1_Y + RAQUETTE_VITESSE;
	}
	
	// Animation de la raquette du joueur 2
	var animerRaquetteJ2 = function () {
		if (aller_haut_J2 && RAQUETTE_J2_Y > 0)
			RAQUETTE_J2_Y = RAQUETTE_J2_Y - RAQUETTE_VITESSE;
		else if (aller_bas_J2 && RAQUETTE_J2_Y < TERRAIN_HEIGHT - RAQUETTE_HEIGHT)
			RAQUETTE_J2_Y = RAQUETTE_J2_Y + RAQUETTE_VITESSE;
	}
...
/* FONCTION DE GESTION DE LA PERTE DE BALLE */
	...
	var ballePerdueJ2 = function (positionXBalle, positionXJ2) {
		...
		if (positionXBalle > positionXJ2 + RAQUETTE_WIDTH) {
			console.log("Le Joueur 2 perd la balle");
		    valeurRetour = true;
		}
		return valeurRetour;
	}
